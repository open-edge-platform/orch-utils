...
func (report *CustomReport) generateHumanDiffOutput(output stringWriter, diff dyff.Diff, useGoPatchPaths bool, showPathRoot bool) error {
...
func (report *CustomReport) generateHumanDetailOutput(detail dyff.Detail) (string, error) {
	switch detail.Kind {
	case dyff.ADDITION:
...
func (report *CustomReport) generateHumanDetailOutputAddition(detail dyff.Detail) (string, error) {
...
func (report *CustomReport) generateHumanDetailOutputRemoval(detail dyff.Detail) (string, error) {
	var output bytes.Buffer
	...
	case yamlv3.MappingNode:
		text := text.Plural(len(detail.From.Content)/2, "field", "fields")
		_, _ = output.WriteString(yellow("%c %s removed:\n", dyff.REMOVAL, text))
	}
...
func (report *CustomReport) generateHumanDetailOutputModification(detail dyff.Detail) (string, error) {
	var output bytes.Buffer
...
func (report *CustomReport) generateHumanDetailOutputOrderchange(detail dyff.Detail) (string, error) {
	var output bytes.Buffer
...
func (report *CustomReport) writeStringDiff(output stringWriter, from string, to string) {
...
func (report *CustomReport) highlightByLine(from, to string) string {
...
func (report *CustomReport) writeTextBlocks(buf stringWriter, indent int, blocks ...string) {
	const separator = "   "
