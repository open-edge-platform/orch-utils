...
func HasOrgWith(preds ...predicate.Org) predicate.Folder {
	return predicate.Folder(func(s *sql.Selector) {
		step := newOrgStep()
...
func HasProjects() predicate.Folder {
	return predicate.Folder(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasProjectsWith(preds ...predicate.Project) predicate.Folder {
	return predicate.Folder(func(s *sql.Selector) {
