...
func (_q *OrgQuery) QueryFolders() *FolderQuery {
...
func (_q *OrgQuery) QueryProjects() *ProjectQuery {
...
func (_q *OrgQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OrgQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *OrgQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OrgQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *OrgQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *OrgQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *OrgQuery) WithFolders(opts ...func(*FolderQuery)) *OrgQuery {
	query := (&FolderClient{config: _q.config}).Query()
...
func (_q *OrgQuery) WithProjects(opts ...func(*ProjectQuery)) *OrgQuery {
	query := (&ProjectClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrgQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Org, error) {
	...
	if query := _q.withFolders; query != nil {
		if err := _q.loadFolders(ctx, query, nodes,
			func(n *Org) { n.Edges.Folders = []*Folder{} },
			func(n *Org, e *Folder) { n.Edges.Folders = append(n.Edges.Folders, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withProjects; query != nil {
		if err := _q.loadProjects(ctx, query, nodes,
			func(n *Org) { n.Edges.Projects = []*Project{} },
			func(n *Org, e *Project) { n.Edges.Projects = append(n.Edges.Projects, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *OrgQuery) loadFolders(ctx context.Context, query *FolderQuery, nodes []*Org, init func(*Org), assign func(*Org, *Folder)) error {
	...
	query.Where(predicate.Folder(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(org.FoldersColumn), fks...))
	}))
	...
	for _, n := range neighbors {
		fk := n.org_folders
		if fk == nil {
			return fmt.Errorf(`foreign-key "org_folders" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "org_folders" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *OrgQuery) loadProjects(ctx context.Context, query *ProjectQuery, nodes []*Org, init func(*Org), assign func(*Org, *Project)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Org)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Project(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(org.ProjectsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.org_projects
		if fk == nil {
			return fmt.Errorf(`foreign-key "org_projects" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "org_projects" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
