...
// The ControllerStatusFunc type is an adapter to allow the use of ordinary
// function as ControllerStatus mutator.
type ControllerStatusFunc func(context.Context, *ent.ControllerStatusMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ControllerStatusFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ControllerStatusMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ControllerStatusMutation", m)
}
...
// The TenancyEventFunc type is an adapter to allow the use of ordinary
// function as TenancyEvent mutator.
type TenancyEventFunc func(context.Context, *ent.TenancyEventMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TenancyEventFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TenancyEventMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TenancyEventMutation", m)
}
