...
require (
	...
	github.com/open-edge-platform/orch-utils/tenancy-datamodel v1.2.3-0.20251126124158-7e4ecb820281
...
replace github.com/open-edge-platform/orch-utils/tenancy-datamodel => ../tenancy-datamodel
